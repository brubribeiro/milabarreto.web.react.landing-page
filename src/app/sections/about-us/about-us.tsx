...
export function AboutUs() {
  return (
    <section className="py-32 px-8 relative bg-gradient-to-br from-white to-secondary" id="sobre">
      <h2 className="text-center text-4xl mb-12 text-gray-dark">Sobre nossa Clínica</h2>
